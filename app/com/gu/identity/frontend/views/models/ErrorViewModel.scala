...
object ErrorViewModel {
  ...
  val errorMessages = Map(
    ...
    "signin-error-bad-request" -> "There was a problem with your email or password; please try again.",
    "signin-error-credentials" -> "Incorrect email or password; please try again.",
    ...
    "register-error-username-conflict" -> "The username you selected is already in use; please choose another one.",
    "register-error-email-conflict" -> "This email is already in use; please check you do not already have an account.",
