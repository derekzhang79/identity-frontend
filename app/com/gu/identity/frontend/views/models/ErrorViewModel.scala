...
object ErrorViewModel {
  ...
  val errorMessages: Map[ErrorID, String] = Map(
    ...
    RegisterActionInvalidDisplaynameErrorID -> "Invalid display name; your display name must be between 6 and 20 characters long and contain only letters and numbers.",
